  ...
  try {
    ...
    if (rfqCount === 0 && stockItem1 && sup1) {
      await PurchaseRfq.bulkCreate([
        ...
        {
          rfqNo: 'RFQ-2026-0002',
          supplierId: sup2 ? sup2.id : sup1.id,
          supplierName: sup2 ? sup2.companyName : 'Erdemir Çelik Sanayi A.Ş.',
          stockItemId: stockItem1.id,
          requestedQuantity: 2000,
          offeredUnitPrice: 3.85,
          offeredTotalPrice: 7700.00,
          currency: 'TRY',
          deliveryDays: 3,
          paymentTerm: 'Vadeli_30',
          validUntil: '2026-08-28',
          qualityNote: 'A-Segment Birinci Sınıf Üretim',
          status: 'Received',
          isWinner: false,
          requestedBy: 'Caner Öztürk',
          createdBy: purchaseUser.id
        ...
        {
          rfqNo: 'RFQ-2026-0003',
          supplierId: sup3 ? sup3.id : sup1.id,
          supplierName: sup3 ? sup3.companyName : 'Tekno Civata Endüstri A.Ş.',
          stockItemId: stockItem1.id,
          requestedQuantity: 2000,
          offeredUnitPrice: 4.50,
          offeredTotalPrice: 9000.00,
          currency: 'TRY',
          deliveryDays: 8,
          paymentTerm: 'Pesin',
          validUntil: '2026-08-25',
          qualityNote: 'Standart ISO Sertifikalı',
          status: 'Received',
          isWinner: false,
          requestedBy: 'Caner Öztürk',
          createdBy: purchaseUser.id
        ...
        {
          rfqNo: 'RFQ-2026-0005',
          supplierId: sup1 ? sup1.id : sup1.id,
          supplierName: sup1 ? sup1.companyName : 'Borusan Mannesmann A.Ş.',
          stockItemId: stockItem3 ? stockItem3.id : stockItem1.id,
          requestedQuantity: 500,
          offeredUnitPrice: 415.00,
          offeredTotalPrice: 207500.00,
          currency: 'TRY',
          deliveryDays: 4,
          paymentTerm: 'Vadeli_60',
          validUntil: '2026-08-29',
          qualityNote: 'Lazer Kesim & Sertifikalı Özel Sac',
          status: 'Received',
          isWinner: false,
          requestedBy: 'Caner Öztürk',
          createdBy: purchaseUser.id
