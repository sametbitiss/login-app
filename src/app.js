...
(async () => {
  try {
    ...
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ADD COLUMN IF NOT EXISTS "gecerlilikBaslangic" DATE;`);
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ADD COLUMN IF NOT EXISTS "gecerlilikBitis" DATE;`);
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ADD COLUMN IF NOT EXISTS "durum" VARCHAR(50) DEFAULT 'Active';`);
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ADD COLUMN IF NOT EXISTS "kalemTuru" VARCHAR(50) DEFAULT 'Material';`);
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ALTER COLUMN "bilesenStokId" DROP NOT NULL;`).catch(() => {});
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ALTER COLUMN "gerekliMiktar" DROP NOT NULL;`).catch(() => {});
    await sequelize.query(`ALTER TABLE "UrunReceteleri" ALTER COLUMN "birim" DROP NOT NULL;`).catch(() => {});
