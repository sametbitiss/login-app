...
const DEFAULT_ROLES = [
  { key: 'Admin', label: 'Sistem Yöneticisi & Admin', department: 'Sistem Yönetimi & Güvenlik', description: 'Tüm modüllere ve sistem parametrelerine tam yetkili üst yönetici', isSystem: true },
  { key: 'Stock_Manager', label: 'Stok & Depo Yöneticisi', department: 'Stok & Depo Yönetimi', description: 'Depo, lokasyon, fiziki sayım ve transfer işlemlerini yöneten birim yöneticisi', isSystem: false },
  { key: 'Sales_Manager', label: 'Satış & Pazarlama Müdürü', department: 'Satış Yönetimi', description: 'Satış teklif, sipariş, sevkiyat ve müşteri cari hesap yöneticisi', isSystem: false },
  { key: 'Purchase_Manager', label: 'Satın Alma Yöneticisi', department: 'Satın Alma Yönetimi', description: 'Tedarikçi ilişkileri, satın alma sipariş ve RFQ teklif yöneticisi', isSystem: false },
  { key: 'Production_Manager', label: 'Üretim & İmalat Müdürü', department: 'Üretim Planlama & İmalat', description: 'Fabrika imalat iş emirleri, reçete (BOM) ve MRP planlama yöneticisi', isSystem: false },
  { key: 'Quality_Manager', label: 'Kalite Kontrol & Güvence Müdürü', department: 'Kalite Kontrol & Güvence', description: 'Giriş/proses muayeneleri, NCR uygunsuzluk ve CAPA aksiyon yöneticisi', isSystem: false },
  { key: 'Employee', label: 'Departman Uzman Personel', department: 'Genel / Tüm Modüller', description: 'Standart operasyonel kayıt ve izleme yetkisine sahip personel', isSystem: false }
];
